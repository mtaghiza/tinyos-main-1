...
# This class implements a Python interface to the 'CxDownloadStarted'
# message type.
#
...
class CxDownloadStarted(tinyos.message.Message.Message):
    # Create a new CxDownloadStarted of size 1.
