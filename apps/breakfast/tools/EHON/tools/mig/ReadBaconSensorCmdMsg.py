...
# This class implements a Python interface to the 'ReadBaconSensorCmdMsg'
# message type.
#
...
class ReadBaconSensorCmdMsg(Message):
    # Create a new ReadBaconSensorCmdMsg of size 0.
    ...
    #
    def __str__(self):
        s = "Message <ReadBaconSensorCmdMsg> \n"
        try:
            pass
        except:
            pass
