...
#         self.setUIntElement(self.offsetBits_val(9), 8, invFrequency[2], 1)
        self.setUIntElement(self.offsetBits_val(7), 8, bw[0], 1)
        self.setUIntElement(self.offsetBits_val(8), 8, bw[1], 1)
        self.setUIntElement(self.offsetBits_val(9), 8, bw[2], 1)
        self.setUIntElement(self.offsetBits_val(10), 8, maxDepth[0], 1)
        self.setUIntElement(self.offsetBits_val(11), 8, maxDepth[1], 1)
        self.setUIntElement(self.offsetBits_val(12), 8, maxDepth[2], 1)
        #12
        for i in range(3):
            print "ns %u: pi %u md %u -> %u"%(i, probeInterval,
              maxDepth[i], 
              probeInterval*maxDepth[i]*32)
        self.setUIntElement(self.offsetBits_val(16), 32,
          probeInterval*maxDepth[0]*32, 1)
        self.setUIntElement(self.offsetBits_val(20), 32, 
          probeInterval*maxDepth[1]*32, 1)
        self.setUIntElement(self.offsetBits_val(24), 32, 
          probeInterval*maxDepth[2]*32, 1)
