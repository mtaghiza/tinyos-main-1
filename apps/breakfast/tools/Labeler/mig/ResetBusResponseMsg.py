...
# This class implements a Python interface to the 'ResetBusResponseMsg'
# message type.
#
...
class ResetBusResponseMsg(tinyos.message.Message.Message):
    # Create a new ResetBusResponseMsg of size 1.
