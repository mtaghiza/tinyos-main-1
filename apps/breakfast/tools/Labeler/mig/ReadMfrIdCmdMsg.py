...
# This class implements a Python interface to the 'ReadMfrIdCmdMsg'
# message type.
#
...
class ReadMfrIdCmdMsg(tinyos.message.Message.Message):
    # Create a new ReadMfrIdCmdMsg of size 0.
