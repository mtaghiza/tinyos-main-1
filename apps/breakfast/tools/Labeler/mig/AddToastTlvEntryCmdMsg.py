...
# This class implements a Python interface to the 'AddToastTlvEntryCmdMsg'
# message type.
#
...
class AddToastTlvEntryCmdMsg(tinyos.message.Message.Message):
    # Create a new AddToastTlvEntryCmdMsg of size 66.
    ...
    #
    def __str__(self):
        s = "Message <AddToastTlvEntryCmdMsg> \n"
        try:
            s += "  [tag=0x%x]\n" % (self.get_tag())
        except:
            pass
