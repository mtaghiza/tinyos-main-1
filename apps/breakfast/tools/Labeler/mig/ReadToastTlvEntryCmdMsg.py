...
# This class implements a Python interface to the 'ReadToastTlvEntryCmdMsg'
# message type.
#
...
class ReadToastTlvEntryCmdMsg(tinyos.message.Message.Message):
    # Create a new ReadToastTlvEntryCmdMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <ReadToastTlvEntryCmdMsg> \n"
        try:
            s += "  [tag=0x%x]\n" % (self.get_tag())
        except:
            pass
