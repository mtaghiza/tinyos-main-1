...
# This class implements a Python interface to the 'WriteToastBarcodeIdResponseMsg'
# message type.
#
...
class WriteToastBarcodeIdResponseMsg(tinyos.message.Message.Message):
    # Create a new WriteToastBarcodeIdResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <WriteToastBarcodeIdResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
