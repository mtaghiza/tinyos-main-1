...
# This class implements a Python interface to the 'ReadToastBarcodeIdResponseMsg'
# message type.
#
...
class ReadToastBarcodeIdResponseMsg(tinyos.message.Message.Message):
    # Create a new ReadToastBarcodeIdResponseMsg of size 11.
    ...
    #
    def __str__(self):
        s = "Message <ReadToastBarcodeIdResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
