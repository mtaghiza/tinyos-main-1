...
# This class implements a Python interface to the 'WriteToastTlvResponseMsg'
# message type.
#
...
class WriteToastTlvResponseMsg(tinyos.message.Message.Message):
    # Create a new WriteToastTlvResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <WriteToastTlvResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
