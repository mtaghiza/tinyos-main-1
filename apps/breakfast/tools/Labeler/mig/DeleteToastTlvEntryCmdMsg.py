...
# This class implements a Python interface to the 'DeleteToastTlvEntryCmdMsg'
# message type.
#
...
class DeleteToastTlvEntryCmdMsg(tinyos.message.Message.Message):
    # Create a new DeleteToastTlvEntryCmdMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <DeleteToastTlvEntryCmdMsg> \n"
        try:
            s += "  [tag=0x%x]\n" % (self.get_tag())
        except:
            pass
