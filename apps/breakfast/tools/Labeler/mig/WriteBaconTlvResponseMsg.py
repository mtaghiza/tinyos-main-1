...
# This class implements a Python interface to the 'WriteBaconTlvResponseMsg'
# message type.
#
...
class WriteBaconTlvResponseMsg(tinyos.message.Message.Message):
    # Create a new WriteBaconTlvResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <WriteBaconTlvResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
