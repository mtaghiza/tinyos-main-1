...
# This class implements a Python interface to the 'ReadBaconTlvEntryCmdMsg'
# message type.
#
...
class ReadBaconTlvEntryCmdMsg(tinyos.message.Message.Message):
    # Create a new ReadBaconTlvEntryCmdMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <ReadBaconTlvEntryCmdMsg> \n"
        try:
            s += "  [tag=0x%x]\n" % (self.get_tag())
        except:
            pass
