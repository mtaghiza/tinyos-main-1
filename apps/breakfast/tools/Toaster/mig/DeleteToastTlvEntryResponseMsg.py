...
# This class implements a Python interface to the 'DeleteToastTlvEntryResponseMsg'
# message type.
#
...
class DeleteToastTlvEntryResponseMsg(tinyos.message.Message.Message):
    # Create a new DeleteToastTlvEntryResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <DeleteToastTlvEntryResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
