...
# This class implements a Python interface to the 'SetBusPowerResponseMsg'
# message type.
#
...
class SetBusPowerResponseMsg(tinyos.message.Message.Message):
    # Create a new SetBusPowerResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <SetBusPowerResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
