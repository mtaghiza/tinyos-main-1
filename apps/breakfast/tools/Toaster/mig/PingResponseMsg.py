...
# This class implements a Python interface to the 'PingResponseMsg'
# message type.
#
...
class PingResponseMsg(tinyos.message.Message.Message):
    # Create a new PingResponseMsg of size 1.
