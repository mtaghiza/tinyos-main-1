...
# This class implements a Python interface to the 'ReadToastAssignmentsCmdMsg'
# message type.
#
...
class ReadToastAssignmentsCmdMsg(tinyos.message.Message.Message):
    # Create a new ReadToastAssignmentsCmdMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <ReadToastAssignmentsCmdMsg> \n"
        try:
            s += "  [tag=0x%x]\n" % (self.get_tag())
        except:
            pass
