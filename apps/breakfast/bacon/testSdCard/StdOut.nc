...
interface StdOut {
  ...
  */
  ...
  async command uint16_t print(const char * str);

  /** Format value as a hex string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printHex(uint8_t c);

  /** Format value as a hex string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printHexword(uint16_t c);

  /** Format value as a hex string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printHexlong(uint32_t c);
  ...
  /** Format value as a base10 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase10uint8(const uint8_t c);

  /** Format value as a base10 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase10int8(const int8_t c);

  /** Format value as a base10 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase10uint16(const uint16_t c);

  /** Format value as a base10 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase10int16(const int16_t c);

  /** Format value as a base10 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase10uint32(const uint32_t c);

  /** Format value as a base10 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase10int32(const int32_t c);

  /** Format value as a base10 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase10float(float c);

  /** Format value as a base2 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase2uint8(uint8_t c);

  /** Format value as a base2 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase2uint16(uint16_t c);

  /** Format value as a base2 string and put it into the output buffer.
      @param c Numberical value to be formatted and printed.
      @return Number of bytes actually buffered. */
  async command uint8_t printBase2uint32(uint32_t c);
