...
# This class implements a Python interface to the 'ReadBaconTlvCmdMsg'
# message type.
#
...
class ReadBaconTlvCmdMsg(tinyos.message.Message.Message):
    # Create a new ReadBaconTlvCmdMsg of size 0.
