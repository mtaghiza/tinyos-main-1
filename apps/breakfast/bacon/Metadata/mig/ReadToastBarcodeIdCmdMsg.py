...
# This class implements a Python interface to the 'ReadToastBarcodeIdCmdMsg'
# message type.
#
...
class ReadToastBarcodeIdCmdMsg(tinyos.message.Message.Message):
    # Create a new ReadToastBarcodeIdCmdMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <ReadToastBarcodeIdCmdMsg> \n"
        try:
            s += "  [tag=0x%x]\n" % (self.get_tag())
        except:
            pass
