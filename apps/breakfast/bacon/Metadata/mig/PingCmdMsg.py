...
# This class implements a Python interface to the 'PingCmdMsg'
# message type.
#
...
class PingCmdMsg(tinyos.message.Message.Message):
    # Create a new PingCmdMsg of size 0.
