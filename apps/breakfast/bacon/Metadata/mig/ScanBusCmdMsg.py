...
# This class implements a Python interface to the 'ScanBusCmdMsg'
# message type.
#
...
class ScanBusCmdMsg(tinyos.message.Message.Message):
    # Create a new ScanBusCmdMsg of size 0.
