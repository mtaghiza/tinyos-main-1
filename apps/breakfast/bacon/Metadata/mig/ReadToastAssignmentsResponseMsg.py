...
# This class implements a Python interface to the 'ReadToastAssignmentsResponseMsg'
# message type.
#
...
DEFAULT_MESSAGE_SIZE = 27

# The Active Message type associated with this message.
AM_TYPE = 141

class ReadToastAssignmentsResponseMsg(tinyos.message.Message.Message):
    # Create a new ReadToastAssignmentsResponseMsg of size 27.
    def __init__(self, data="", addr=None, gid=None, base_offset=0, data_length=27):
    ...
    #
    def __str__(self):
        s = "Message <ReadToastAssignmentsResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
