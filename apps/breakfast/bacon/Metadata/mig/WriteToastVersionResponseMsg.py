...
# This class implements a Python interface to the 'WriteToastVersionResponseMsg'
# message type.
#
...
class WriteToastVersionResponseMsg(tinyos.message.Message.Message):
    # Create a new WriteToastVersionResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <WriteToastVersionResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
