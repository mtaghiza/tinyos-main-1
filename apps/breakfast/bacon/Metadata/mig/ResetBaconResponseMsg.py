...
# This class implements a Python interface to the 'ResetBaconResponseMsg'
# message type.
#
...
class ResetBaconResponseMsg(tinyos.message.Message.Message):
    # Create a new ResetBaconResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <ResetBaconResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
