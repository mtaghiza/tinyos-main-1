...
# This class implements a Python interface to the 'ReadBaconVersionResponseMsg'
# message type.
#
...
class ReadBaconVersionResponseMsg(tinyos.message.Message.Message):
    # Create a new ReadBaconVersionResponseMsg of size 4.
    ...
    #
    def __str__(self):
        s = "Message <ReadBaconVersionResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
