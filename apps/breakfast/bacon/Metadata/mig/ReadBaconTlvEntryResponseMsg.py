...
# This class implements a Python interface to the 'ReadBaconTlvEntryResponseMsg'
# message type.
#
...
DEFAULT_MESSAGE_SIZE = 131

# The Active Message type associated with this message.
AM_TYPE = 171

class ReadBaconTlvEntryResponseMsg(tinyos.message.Message.Message):
    # Create a new ReadBaconTlvEntryResponseMsg of size 131.
    def __init__(self, data="", addr=None, gid=None, base_offset=0, data_length=131):
    ...
    #
    def __str__(self):
        s = "Message <ReadBaconTlvEntryResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
