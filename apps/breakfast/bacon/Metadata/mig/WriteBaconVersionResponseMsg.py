...
# This class implements a Python interface to the 'WriteBaconVersionResponseMsg'
# message type.
#
...
class WriteBaconVersionResponseMsg(tinyos.message.Message.Message):
    # Create a new WriteBaconVersionResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <WriteBaconVersionResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
