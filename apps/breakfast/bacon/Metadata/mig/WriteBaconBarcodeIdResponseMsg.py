...
# This class implements a Python interface to the 'WriteBaconBarcodeIdResponseMsg'
# message type.
#
...
class WriteBaconBarcodeIdResponseMsg(tinyos.message.Message.Message):
    # Create a new WriteBaconBarcodeIdResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <WriteBaconBarcodeIdResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
