...
# This class implements a Python interface to the 'DeleteBaconTlvEntryCmdMsg'
# message type.
#
...
class DeleteBaconTlvEntryCmdMsg(tinyos.message.Message.Message):
    # Create a new DeleteBaconTlvEntryCmdMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <DeleteBaconTlvEntryCmdMsg> \n"
        try:
            s += "  [tag=0x%x]\n" % (self.get_tag())
        except:
            pass
