...
# This class implements a Python interface to the 'ResetBaconCmdMsg'
# message type.
#
...
class ResetBaconCmdMsg(tinyos.message.Message.Message):
    # Create a new ResetBaconCmdMsg of size 0.
