...
# This class implements a Python interface to the 'AddBaconTlvEntryResponseMsg'
# message type.
#
...
class AddBaconTlvEntryResponseMsg(tinyos.message.Message.Message):
    # Create a new AddBaconTlvEntryResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <AddBaconTlvEntryResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
