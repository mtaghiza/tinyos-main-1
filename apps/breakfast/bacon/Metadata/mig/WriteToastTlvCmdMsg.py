...
# This class implements a Python interface to the 'WriteToastTlvCmdMsg'
# message type.
#
...
class WriteToastTlvCmdMsg(tinyos.message.Message.Message):
    # Create a new WriteToastTlvCmdMsg of size 64.
