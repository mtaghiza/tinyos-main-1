...
# This class implements a Python interface to the 'WriteToastAssignmentsResponseMsg'
# message type.
#
...
class WriteToastAssignmentsResponseMsg(tinyos.message.Message.Message):
    # Create a new WriteToastAssignmentsResponseMsg of size 1.
    ...
    #
    def __str__(self):
        s = "Message <WriteToastAssignmentsResponseMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
