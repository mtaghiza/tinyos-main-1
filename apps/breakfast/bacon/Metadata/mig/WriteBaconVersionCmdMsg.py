...
# This class implements a Python interface to the 'WriteBaconVersionCmdMsg'
# message type.
#
...
class WriteBaconVersionCmdMsg(tinyos.message.Message.Message):
    # Create a new WriteBaconVersionCmdMsg of size 4.
    ...
    #
    def __str__(self):
        s = "Message <WriteBaconVersionCmdMsg> \n"
        try:
            s += "  [tag=0x%x]\n" % (self.get_tag())
        except:
            pass
