...
# This class implements a Python interface to the 'ReadAdcCCmdMsg'
# message type.
#
...
class ReadAdcCCmdMsg(tinyos.message.Message.Message):
    # Create a new ReadAdcCCmdMsg of size 0.
