...
# This class implements a Python interface to the 'ReadToastTlvCmdMsg'
# message type.
#
...
class ReadToastTlvCmdMsg(tinyos.message.Message.Message):
    # Create a new ReadToastTlvCmdMsg of size 0.
