...
# This class implements a Python interface to the 'ClearSettingsStorageMsg'
# message type.
#
...
class ClearSettingsStorageMsg(tinyos.message.Message.Message):
    # Create a new ClearSettingsStorageMsg of size 19.
    ...
    #
    def __str__(self):
        s = "Message <ClearSettingsStorageMsg> \n"
        try:
            s += "  [error=0x%x]\n" % (self.get_error())
        except:
            pass
